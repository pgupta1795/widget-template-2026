...
import {ApiExplorerProvider,useApiExplorer} from '@/features/api-explorer/context/api-explorer-context';
    ...
    <div className="flex-1 flex flex-col min-w-0 min-h-0 overflow-hidden relative w-full h-full max-w-full">
      <SidebarGroup className="flex-1 overflow-hidden p-0 min-h-0 min-w-0 gap-0 w-full max-w-full absolute inset-0">
        <SidebarGroupContent className="flex-1 flex flex-col overflow-hidden min-h-0 min-w-0 w-full max-w-full">
          <Tabs defaultValue="active" className="flex-1 flex flex-col gap-0 overflow-hidden min-w-0 w-full max-w-full">
            <TabsList
              variant="line"
            ...
            >
              <TabsTrigger value="active" className="gap-1 text-[11px] shrink-0">
                <Layers size={12} /> Active
              </TabsTrigger>
              <TabsTrigger value="browse" className="gap-1 text-[11px] shrink-0">
                <Globe size={12} /> Browse
              </TabsTrigger>
              <TabsTrigger value="history" className="gap-1 text-[11px] shrink-0">
                <Clock size={12} /> History
              </TabsTrigger>
            </TabsList>

            <TabsContent value="active" className="flex-1 overflow-hidden min-w-0 mt-0">
            ...
            <TabsContent value="browse" className="flex-1 overflow-hidden min-w-0 mt-0">
              <ScrollArea className="h-full w-full">
                <div className="pt-2 w-full min-w-0">
                  <SpecBrowser />
                </div>
            ...
            <TabsContent value="history" className="flex-1 overflow-hidden min-w-0 mt-0">
              <ScrollArea className="h-full w-full">
                <div className="pt-2 w-full min-w-0">
                  <HistoryPanel />
                </div>
