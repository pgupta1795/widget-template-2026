 ...
 */
export async function executeWafRequest(
	req: ExecutorRequest,
	...
	const opts = {
		params:
			Object.keys(req.queryParams).length > 0 ? req.queryParams : undefined,
		headers:
			Object.keys(req.extraHeaders).length > 0 ? req.extraHeaders : undefined,
