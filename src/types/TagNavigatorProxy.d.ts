...
export interface AbstractTagger6WProxy {
	 ...
	 */
	addLocalFilter(filter: Filter6WTagger["localfilters"], warn?: boolean): void;
	 ...
	 */
	setLocalFilter(filter: Filter6WTagger["localfilters"], warn?: boolean): void;
...
export interface Tagger6WProxy extends AbstractTagger6WProxy {
	 ...
	 */
	addSubjects(tagsdata: TaggerSubjectsTags): Tagger6WProxy;
 ...
 */
export interface Tagger6WProxyWithFilteringServices
	extends AbstractTagger6WProxy {
	/**
...
export type TagNavigatorFilteringMode =
	| "FilteringOnServer"
	| "WithFilteringServices";
