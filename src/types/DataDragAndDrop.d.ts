...
export interface DataDragAndDropDroppableOptions {
   ...
   */
  drop?(dataTransfer: DataTransfer | null, element: Element, event: DragEvent): void;
}
...
export interface DataDragAndDrop {
  ...
  draggable(
    element: Element,
    options: DataDragAndDropDraggableOptions
  ): void;
  ...
  droppable(
    element: Element,
    options: DataDragAndDropDroppableOptions
  ): void;
