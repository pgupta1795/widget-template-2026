...
export interface GetPlatformServicesOptionsBase {
	onComplete(
		data: PlatformServicesEntry | PlatformServicesEntry[] | undefined,
	): void;
	onFailure?(error: Error): void;
}

export interface GetPlatformServicesOptionsWithId
	extends GetPlatformServicesOptionsBase {
	platformId: string;
}

export interface GetPlatformServicesOptionsAll
	extends GetPlatformServicesOptionsBase {
...
export interface GetServiceUrlOptionsWithPlatform
	extends GetServiceUrlOptionsBase {
	serviceName: string;
	platformId: string;
}

export interface GetServiceUrlOptionsAllPlatforms
	extends GetServiceUrlOptionsBase {
	serviceName: string;
	platformId?: "" | null | undefined;
}
