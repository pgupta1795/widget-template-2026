...
class Logger {
  ...
  info(message: string, ...args: any[]) {
    console.info(this.formatMessage('info', message), ...this.getStyles('info'), ...args);
  }

  warn(message: string, ...args: any[]) {
    console.warn(this.formatMessage('warn', message), ...this.getStyles('warn'), ...args);
  }

  error(message: string, ...args: any[]) {
    console.error(this.formatMessage('error', message), ...this.getStyles('error'), ...args);
  }

  debug(message: string, ...args: any[]) {
    if (import.meta.env.DEV) {
      console.debug(this.formatMessage('debug', message), ...this.getStyles('debug'), ...args);
    }
  }
}
