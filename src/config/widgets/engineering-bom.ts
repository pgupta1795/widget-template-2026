  ...
  tabs: [
    {
      ...
      content: {
        ...
        table: {
          columns: [
            { id: "icon", header: "", accessorKey: "icon", type: "image", width: 36, sortable: false },
            { id: "title", header: "Title", accessorKey: "title", type: "text", sortable: true, filterable: true, minWidth: 150 },
            { id: "name", header: "Name", accessorKey: "name", type: "text", sortable: true, filterable: true, minWidth: 180 },
            { id: "revision", header: "Revision", accessorKey: "revision", type: "text", sortable: true, width: 80 },
            {
              id: "state",
            ...
            { id: "type", header: "Type", accessorKey: "type", type: "text", sortable: true, width: 120 },
            { id: "owner", header: "Owner", accessorKey: "owner", type: "text", sortable: true, width: 120 },
            { id: "description", header: "Description", accessorKey: "description", type: "text", sortable: false, minWidth: 200 },
          ],
          commands: [
            {
              id: "view-info",
              ...
              panelConfig: {
                ...
                width: "md",
                sections: [
                  { label: "General", fields: ["title", "name", "revision", "type", "state", "description"] },
                  { label: "Ownership", fields: ["owner", "organization", "collabspace"] },
                  { label: "Weight & COG", fields: ["declaredWeight", "Weight", "V_WCG_Declared_COGx", "V_WCG_Declared_COGy", "V_WCG_Declared_COGz"] },
                ],
              },
            },
            { id: "expand", label: "Expand", icon: "chevron-down", type: "expand" },
            {
              id: "edit",
              label: "Edit",
              icon: "pencil",
            ...
            { id: "navigate", label: "Open in 3DDashboard", icon: "external-link", type: "navigate" },
          ],
          selectable: true,
          expandable: true,
          pagination: { pageSize: 25, pageSizeOptions: [10, 25, 50, 100] },
          defaultSort: { id: "title", desc: false },
          toolbar: { search: true, actions: [{ id: "refresh", label: "Refresh", icon: "refresh", variant: "ghost" }] },
        },
      },
    },
    {
